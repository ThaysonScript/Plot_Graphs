...
def analisar_sem_ciclos(df, minimum_process_occurrences):
...
def fragmentacao(minimum_process_occurrences=1, analisar_ciclo=False, processo_manual=False):        
    # Read the CSV file into a DataFrame
    df = pd.read_csv(pasta_logs, delimiter=';')
    
    analisar_ciclos(df, minimum_process_occurrences, analisar_ciclo, processo_manual)
    analisar_sem_ciclos(df, minimum_process_occurrences)